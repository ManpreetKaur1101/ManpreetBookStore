...
moreover, in layout.cshtml moved category link to content manager drop down and review changes....
i modified index.cshtml to add icons in the category section .
